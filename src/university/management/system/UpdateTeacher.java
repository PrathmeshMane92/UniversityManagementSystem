    ...
    UpdateTeacher() {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                labelfname.setText(rs.getNString("fname"));
                labeldob.setText(rs.getNString("dob"));
                tfaddress.setText(rs.getNString("address"));
                tfphone.setText(rs.getNString("phone"));
                tfemail.setText(rs.getNString("email"));
                labelx.setText(rs.getNString("class_x"));
                labelxii.setText(rs.getNString("class_xii"));
                labelaadhar.setText(rs.getNString("adhar"));
                labelEmpId.setText(rs.getNString("empId"));
                tfcourse.setText(rs.getNString("education"));
                tfbranch.setText(rs.getNString("department"));
